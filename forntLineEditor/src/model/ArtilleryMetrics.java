...
public class ArtilleryMetrics {
	 ...
	 * gathered there**/
	public ArrayList<String> getArtillery() {
		
			try {
				
			    URL url = new URL("http://www.military-today.com/artillery.htm");
			    ...
			    Boolean bateryAct = false;

	            while ((line = reader.readLine()) != null) {
	            		            	
	            	if(line.contains("Self-Propelled Guns and Howitzers")) { 
	            		
	            		bateryAct = true;
	            		
	            	}
	            	
	            	if(bateryAct == true && line.contains("alt=") && !line.contains("flags")) {
	            		
	            		String[] parts = line.split("alt=\"");
	            		parts[1] = parts[1].substring(0,parts[1].indexOf("\""));
	            			            		
	            		if(parts[1].equals("Guided Artillery Shells") || parts[1].contains("Intellectus Publishing ")) {
	            			
	            			return arBatery;
	            			
	            		}
        		
	            		arBatery.add(parts[1]);
